...
import { MonthDisplay } from "../../components/home/MonthDisplay";
import { MonthTransition } from "../../components/home/MonthTransition";

export default {
    title: 'Home/MonthDisplay',
    component: MonthDisplay
} as ComponentMeta<typeof MonthDisplay>;

const Template: ComponentStory<typeof MonthDisplay> = (args) => {
    return (
        <div style={{ width: '50%'}}>
            <MonthDisplay {...args} />
        </div>
